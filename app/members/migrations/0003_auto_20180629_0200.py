# Generated by Django 2.0.6 on 2018-06-29 02:00
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('relation_type', models.CharField(choices=[('f', 'Fllow'), ('b', 'BLOCK')], max_length=1)),
                ('form_user', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='relations_by_from_user', to=settings.AUTH_USER_MODEL)),
